...
class YPLibraryViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        let c = NSLayoutConstraint(item: multipleSelectionIndicator, attribute: .left, relatedBy: .equal, toItem: lblUtamaContainer, attribute: .right, multiplier: 1, constant: 15)
